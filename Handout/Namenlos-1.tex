...
\item{\cventry{}{Tags zeigen auf einen Commit. Mit Tags können wichtige Versionen markiert und benannt werden.}{Tag}{}{}{(Außerdem zeigen spezielle Tags auf den neusten Commit eines Braches, so werden Branches intern realisert. Der Tag HEAD markiert die Version auf der momentan gearbeitet wird.)}}
