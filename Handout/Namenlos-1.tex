...
\item{\cventry{}{git fetch; git merge; git push}{copy - modify - merge}{}{}{\vspace{3pt}Damit mehrere Entwickler gleichzeitig an der gleichen Datei arbeiten können, kopiert sich jeder Entwickler die aktuelle Version und macht Änderungen daran. Die Änderungen werden später zusammengeführt (Merge). Das geschieht mit einem Merge-Algorithmus. Kann dieser die Änderungen nicht zusammenführen, da sie im Widerspruch zueinander stehen, spricht man von einem Mergekonflikt, der von einem Mensch aufgelöst werden muss.}}

\vspace{6pt}

\item{\cventry{}{git commit}{commit}{}{}{\vspace{3pt}Mit einem Commit speichert man den aktuellen Zustand von Dateien oder Verzeichnissen. Ein Commit enthält nicht nur eine Referenz auf den eingepflegten Zustand des Projekts (Roottree s.u), sondern enthält auch Autor, eine Beschreibung der vorgenommenen Änderungen, sowie den Namen des vorangegangenen Commit. Commits sind, wie alle Git-Objekte, mit ihrem SHA1-Prüfwert eindeutig benannt.}}

\vspace{6pt}

\item{\cventry{}{git branch; git checkout}{branching}{}{}{\vspace{3pt}Um parallel an mehreren Versionen arbeiten zu können, gibt es sogenannte Branches (engl. für Zweige). Branches können unterschiedlich genutzt werden, zum Beispiel um eine stabil laufende Version eines Programms zur Verfügung zu haben, während man in einem anderen Branch an neuen Funktionen arbeitet.}}

\section{Objekte}
Git speichert alles in Objekten ($\neq$ Objekte in OOP). Es gibt verschiedene Arten von Objekten.
\vspace{6pt}
\item{\cventry{}{Enthält den Inhalt einzelner Dateien. Blob ist kurz für Binary Large Object.}{Blob}{}{}{}}
\item{\cventry{}{Bildet Ordnerstruktur ab. Kann weitere Trees oder Blobs enthalten}{Tree}{}{}{}}
\item{\cventry{}{Stellt wie oben beschrieben eine Version dar. Die Referenz auf die Änderungen ist ein Tree.}{Commit}{}{}{}}
\item{\cventry{}{Tags zeigen auf einen Commit. Mit Tags können wichtige Versionen markiert und benannt werden.}{Tag}{}{}{(Außerdem zeigen spezielle Tags auf den neuesten Commit eines Brach. So werden Branches intern realisert. Der Tag HEAD markiert die Version auf der momentan gearbeitet wird.)}}
